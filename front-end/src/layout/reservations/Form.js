...
const Form = ({ reservation, setNewRes }) => {
    ...
    <div>
      ...
      <form onSubmit={reservation_id ? handleUpdateSubmit : handleCreateSubmit}>
        ...
        <input
          ...
          placeholder={
            formData.mobile_number ? formData.mobile_number : "Mobile Number"
          }
          onChange={handleChange}
        ></input>
        ...
        <input
          ...
          placeholder={
            formData.reservation_date ? formData.reservation_date : "YYYY-MM-DD"
          }
          pattern="\d{4}-\d{2}-\d{2}"
          onChange={handleChange}
        ></input>
        ...
        <input
          ...
          placeholder={
            formData.reservation_time ? formData.reservation_time : "HH:MM"
          }
          pattern="[0-9]{2}:[0-9]{2}"
          onChange={handleChange}
        ></input>
